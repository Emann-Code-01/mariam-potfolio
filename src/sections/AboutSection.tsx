  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col md:flex-row gap-10 md:gap-16 items-start">
        {/* Pull quote */}
        <ScrollReveal direction="right" className="md:w-80 shrink-0">
          <blockquote
            style={{
              fontFamily: 'var(--font-display)',
          ...
          {/* Skill tags */}
          <StaggerContainer className="flex flex-wrap gap-2 mt-8">
            {['SQL', 'Python', 'Power BI', 'Tableau', 'Excel'].map(skill => (
              <StaggerItem key={skill} direction="up" distance={10}>
                <span
                  style={{
