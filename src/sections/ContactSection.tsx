...
export default function ContactSection() {
  return (
    ...
    >
        ...
        <div className="lg:col-span-5 flex flex-col gap-4">
          <ScrollReveal direction="up" delay={0.25} distance={20}>
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              href="mailto:bhadmusmariam590@gmail.com"
              className="group relative inline-flex items-center justify-center gap-4 px-8 py-5 bg-highlight text-primary rounded-full overflow-hidden transition-all duration-500 shadow-[0_0_25px_rgba(201,107,90,0.15)] hover:shadow-[0_0_35px_rgba(201,107,90,0.3)]"
            >
      ...
      <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mt-20">
